		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#barcodescannerbarcodescanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"barcodescannerbarcodescanner-display": {
								"semanticObject": "barcodescannerbarcodescanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=barcodescanner.barcodescanner",
									"url": sap.ui.require.toUrl("barcodescanner/barcodescanner")
								}
							}
						}
					}
